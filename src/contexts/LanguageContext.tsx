...
const translations: Record<Language, Translations> = {
  en: {
    ...
    howMuchTimeWithChild: 'What percentage of your child\'s care would you like to have?',
  ...
  de: {
    ...
    howMuchTimeWithChild: 'Wie viel Prozent der Betreuung möchten Sie mit Ihrem Kind verbringen?',
  ...
  fr: {
    ...
    howMuchTimeWithChild: 'Quel pourcentage de la garde souhaitez-vous avoir avec votre enfant?',
  ...
  es: {
    ...
    howMuchTimeWithChild: '¿Qué porcentaje de la custodia le gustaría tener con su hijo?',
  ...
  it: {
    ...
    howMuchTimeWithChild: 'Che percentuale di affidamento vorresti avere con tuo figlio?',
